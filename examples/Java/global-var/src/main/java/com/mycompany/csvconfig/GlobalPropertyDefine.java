...
public class GlobalPropertyDefine
{
    ...
    public void parseFrom(List<CSVRecord> records)
    {
        ...
        {
            String[] kvList = records.get(10).get(2).split(AutogenConfigManager.TABULAR_ARRAY_DELIM);
        ...
        {
            String[] kvList = records.get(11).get(2).split(AutogenConfigManager.TABULAR_MAP_DELIM1);
            for(int i = 0; i < kvList.length; i++) {
