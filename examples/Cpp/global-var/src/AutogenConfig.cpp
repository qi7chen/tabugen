...
int GlobalPropertyDefine::ParseFromRows(const vector<CSVRow>& rows, GlobalPropertyDefine* ptr)
{
    ...
    {
        const std::vector<absl::string_view>& array = absl::StrSplit(rows[10][2], TABUGEN_ARRAY_DELIM);
    ...
    {
        const std::vector<absl::string_view>& vec = absl::StrSplit(rows[11][2], TABUGEN_MAP_DELIM1);
