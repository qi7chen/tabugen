...
/**
 * Remove all whitespace from the front of @sp.
 * Whitespace means any of [' ', '\n', '\r', '\t'].
 */
std::string& ltrimWhitespace(std::string& sp);

/**
 * Removed all whitespace from the back of @sp.
 * Whitespace means any of [' ', '\n', '\r', '\t'].
 */
std::string& rtrimWhitespace(std::string& sp);

/**
 * Remove all whitespace  from the back and front of @sp.
 * Whitespace means any of [' ', '\n', '\r', '\t'].
 */
inline std::string& trimWhitespace(std::string& sp) {
...
*/
void SplitStringAllowEmpty(std::string full, const char* delim, std::vector<std::string>* result);

/**
* Split a string using a character delimiter.
*/
inline std::vector<std::string> SplitString(const std::string& full, const char* delim, bool skip_empty = false)
{
