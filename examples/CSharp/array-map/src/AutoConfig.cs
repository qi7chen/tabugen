...
public class NewbieGuideDefine
{
    ...
    public void ParseFromRow(List<string> row)
    {
        ...
        {
            var items = row[3].Split(AutogenConfigManager.TAB_ARRAY_DELIM, StringSplitOptions.RemoveEmptyEntries);
        ...
        {
            var items = row[4].Split(AutogenConfigManager.TAB_MAP_DELIM1, StringSplitOptions.RemoveEmptyEntries);
