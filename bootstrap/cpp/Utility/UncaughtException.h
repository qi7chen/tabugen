...
#if !defined(FOLLY_FORCE_EXCEPTION_COUNT_USE_STD) && (defined(__GNUG__) || defined(__clang__))
...
#elif defined(FOLLY_FORCE_EXCEPTION_COUNT_USE_STD) || (defined(_MSC_VER) && (_MSC_VER >= 1900)) // MSVC++ 2015
 ...
 *
 * This function is based on Evgeny Panasyuk's implementation
